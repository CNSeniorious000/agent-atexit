...
const tarballs = [
  { file: "agent-atexit-opencode-0.2.0.tgz", members: ["package/LICENSE", "package/README.md", "package/dist/server.js", "package/dist/skills/defer-cleanup/SKILL.md", "package/dist/worker.js", "package/package.json"], name: "@agent-atexit/opencode" },
  { file: "agent-atexit-dsh-0.2.0.tgz", members: ["package/LICENSE", "package/README.md", "package/cordis.patch.yml", "package/dist/index.js", "package/dist/worker.js", "package/package.json"], name: "@agent-atexit/dsh" },
] as const;
...
for (const tarball of tarballs) {
  ...
  if (manifest.name !== tarball.name || manifest.version !== "0.2.0" || manifest.publishConfig?.access !== "public") throw new Error(`${tarball.file} has invalid package metadata`);
